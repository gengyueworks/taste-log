...
照上面 9 部分的格式，让 agent 从现有站点反向提取。已提取完成的项目化 DESIGN.md：

- **石康阅读站**（宋体纸感长文阅读）：`30-项目-网站/shikang-reading/DESIGN.md`
- **AI News 日报站**（克莱因蓝新闻纸）：`32-AI高质量阅读库/05-情报与深读系统/AI精华情报与深读操作台/10-源头网站活文件/00-站点根文件/ai-news-site/DESIGN.md`
- **主规范**（全站默认审美）：`30-项目-网站/DESIGN.我们自己的风格-主规范.md`

新站开工时：复制最接近的一份到新项目根目录，按项目微调，agent 照此执行。
